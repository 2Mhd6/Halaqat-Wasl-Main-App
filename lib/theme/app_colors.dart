...
class AppColors {
  ...
  static const disabledButtonColor = Color(0xffCCCDD3);
  ...
  static const statusAcceptedBackground = Color(0xFFEDF4FF);
  static const statusAcceptedText = Color(0xFF4A8CFF);
